...
def objective(space):
    kernel_size1, stride1, kernel_size2, stride2, kernel_size3, kernel_size4, kernel_size5 = space

    kernel_size1 = int(kernel_size1)
    stride1 = int(stride1)
    kernel_size2 = int(kernel_size2)
    kernel_size3 = int(kernel_size3)
    kernel_size4 = int(kernel_size4)
    kernel_size5 = int(kernel_size5)
    ...
    model = model(kernel_size1=kernel_size1, stride1=stride1, kernel_size2=kernel_size2, stride2=stride2,
                  kerel_size3=kernel_size3, kernel_size4=kernel_size4, kernel_size5=kernel_size5, **model_config)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        results.save()
        print('validation loss is currently {}'.format(val_loss))
        print('val_loss is of type {}'.format(type(val_loss)))
    return val_loss
...
def main():
    if rank == 0:
        hyperparameters = {'kernelSize1': np.arange(2,12),
    ...
    res_gp = gp_minimize(objective, space, n_calls=20, callback=deadline, random_state=0, verbose=True)
