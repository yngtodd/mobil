...
def objective(space):
    kernel_size1, stride1, kernel_size2, kernel_size3, kernel_size4, kernel_size5 = space
    ...
    model = model(kernel_size1, stride1, kernel_size2, kernel_size3,
                  kernel_size4, kernel_size5, **model_config)
